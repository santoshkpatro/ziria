...
class UserAdmin(BaseUserAdmin):
    ...
    fieldsets = [
        ...
        ("Other info", {"fields": ["is_email_verified", "is_phone_verified"]}),
...
#     list_display = ("id", "store", "full_name", "email", "phone", "is_guest_user")
...
#     list_display = ("id", "store", "order_number", "total", "created_at")
...
class ProductAdmin(admin.ModelAdmin):
    list_display = ("id", "store", "title", "created_at")
